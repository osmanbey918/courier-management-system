...
export default function StaffList() {
  ...
  return (
    <div className="min-h-[87vh] bg-gray-100 py-10 px-5 overflow-x-auto">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-6xl mx-auto overflow-x-auto">
